...
hero:
  ...
  tagline: "A comprehensive, explicit color and text styling library for Zig 0.16.0+. Supports ANSI, bright ANSI, 256-color, RGB, HEX, HSL, HSV, CMYK, LAB, XYZ, palettes, themes, and composable styles."
  image:
...
features:
  ...
  - icon: 🎭
    ...
    details: "16 built-in themes (dark, light, dracula, nord, monokai, tokyo_night, gruvbox, solarized, rose_pine, catppuccin, github, one_dark, material, palenight, everforest, kanagawa, cyberdream). Create custom themes with Theme.init()."
  - icon: 🔄
